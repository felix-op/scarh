...
export default function EstadisticaCard({
	...
	return (
		<div className="flex flex-col gap-2 rounded-2xl bg-white p-5 shadow-[0px_8px_16px_rgba(0,0,0,0.12)] dark:bg-[#0F172A] dark:shadow-[0px_10px_20px_rgba(0,0,0,0.45)]">
