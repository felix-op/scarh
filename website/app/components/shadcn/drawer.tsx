    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          "data-[vaul-drawer-direction=left]:inset-y-2 data-[vaul-drawer-direction=left]:left-2 data-[vaul-drawer-direction=left]:h-[calc(100%-1rem)] data-[vaul-drawer-direction=left]:w-[calc(100%-1rem)] data-[vaul-drawer-direction=left]:rounded-shape-lg data-[vaul-drawer-direction=left]:sm:inset-y-0 data-[vaul-drawer-direction=left]:sm:left-0 data-[vaul-drawer-direction=left]:sm:h-full data-[vaul-drawer-direction=left]:sm:w-[40%] data-[vaul-drawer-direction=left]:sm:max-w-none data-[vaul-drawer-direction=left]:sm:rounded-none data-[vaul-drawer-direction=left]:border-r border-border shadow-card",
          className
        )}
        {...props}
      >
...
function DrawerTitle({
  ...
  return (
    <DrawerPrimitive.Title
      ...
      className={cn("text-foreground font-semibold p-0 !m-0", className)}
      {...props}
    />
  )
}
